...
public class Menucategory_Adapter extends BaseAdapter {
    private Context context;
    private List<String> launchmodel;
    SharedPreferences sharedpreferences ;
    String userId;

    public Menucategory_Adapter(Context context,List<String> launchmodel) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.menucategory_item, null);
        }
...
//        Loadimage(menu_image);
        Glide.with(context)
                ...
                .override(250,250)
                .into(menu_image);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(context.getResources().getDisplayMetrics().widthPixels/4,layoutwidth);
