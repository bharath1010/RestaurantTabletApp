...
SiriWaveCurve.prototype.draw = function() {
	...
	ctx.lineWidth = 10;//this.definition.lineWidth;
...
{ attenuation: -4, lineWidth: 6, opacity: 0.1 },
{ attenuation: -8, lineWidth: 4, opacity: 0.2 },
{ attenuation: 6, lineWidth: 3, opacity: 0.4 },
{ attenuation: 4, lineWidth: 2, opacity: 0.6 },
{ attenuation: 2, lineWidth: 2.5, opacity: 1 },
];
...
function SiriWave(opt) {
	...
	this.color = this._hex2rgb(opt.color || '#FD9B26');
